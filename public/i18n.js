...
(function () {
  const L10N = {
    pt: {
      ...
      "hero.title": "Vai enviar seu currículo para uma vaga?",
      "hero.sub": "Veja antes o que a vaga pede e seu currículo não está deixando claro.",
      "hero.cta": "Analisar meu currículo grátis",
      "hero.note": "Envie seu currículo + cole a vaga · Sem cadastro",
      "hero.pasteLink": "Prefere colar o texto do currículo? Vá ao formulário →",
      // preview (hero — ilustrativo)
      "preview.scoreLabel": "Compatibilidade com a vaga",
      "preview.item1": "Python — bem demonstrado",
      "preview.item2": "AWS — bem demonstrado",
      "preview.item3": "TDD/BDD — pouco evidenciado",
      "preview.note": "Veja o que sua vaga encontra no seu currículo.",
      "preview.example": "Exemplo ilustrativo",
      // form
      ...
      "form.trust2": "✓ Sem cadastro",
      "form.trust3": "✓ PDF ou DOCX · lido no seu navegador, o arquivo não é enviado",
      "form.privacy": "🔒 Seu arquivo é lido no navegador — apenas o texto extraído é enviado para a análise e removido automaticamente em até 24 horas.",
    ...
    en: {
      ...
      "hero.title": "About to send your résumé for a job?",
      "hero.sub": "See first what the job asks for — and what your résumé isn't making clear.",
      "hero.cta": "Analyze my résumé free",
      "hero.note": "Send your résumé + paste the job · No sign-up",
      "hero.pasteLink": "Prefer to paste your résumé text? Go to the form →",
      // preview (hero — illustrative)
      "preview.scoreLabel": "Job match",
      "preview.item1": "Python — well demonstrated",
      "preview.item2": "AWS — well demonstrated",
      "preview.item3": "TDD/BDD — not well evidenced",
      "preview.note": "See what the job finds in your résumé.",
      "preview.example": "Illustrative example",
      ...
      "form.trust2": "✓ No sign-up",
      "form.trust3": "✓ PDF or DOCX · read in your browser, the file is not uploaded",
      "form.privacy": "🔒 Your file is read in your browser — only the extracted text is sent for the analysis and automatically removed within 24 hours.",
    ...
    es: {
      ...
      "hero.title": "¿Vas a enviar tu currículum para una vacante?",
      "hero.sub": "Mira antes qué pide la vacante y qué tu currículum no está dejando claro.",
      "hero.cta": "Analizar mi currículum gratis",
      "hero.note": "Envía tu currículum + pega la vacante · Sin registro",
      "hero.pasteLink": "¿Prefieres pegar el texto del currículum? Ve al formulario →",
      // preview (hero — ilustrativo)
      "preview.scoreLabel": "Compatibilidad con la vacante",
      "preview.item1": "Python — bien demostrado",
      "preview.item2": "AWS — bien demostrado",
      "preview.item3": "TDD/BDD — poco evidenciado",
      "preview.note": "Mira qué encuentra la vacante en tu currículum.",
      "preview.example": "Ejemplo ilustrativo",
      ...
      "form.trust2": "✓ Sin registro",
      "form.trust3": "✓ PDF o DOCX · leído en tu navegador, el archivo no se envía",
      "form.privacy": "🔒 Tu archivo se lee en el navegador — solo el texto extraído se envía para el análisis y se elimina automáticamente en 24 horas.",
